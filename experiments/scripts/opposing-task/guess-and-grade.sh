...
run $@ --qa-df-path $BASE_DIR/weight-diff-20250512-4b-5000-conf-2025-s42/opposing-task-news-on-topic/results.csv

run $@ --qa-df-path $BASE_DIR/weight-diff-20250514-gemma-4b-conf-2025-s42/opposing-task-news-on-topic/results.csv
